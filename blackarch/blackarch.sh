...
# BlackArch Installaltion Script
# Version: 1.0
# Author: Eric Benner
...
# Download script
wget https://raw.githubusercontent.com/eb3095/arch-scripted/master/blackarch/blackarch-chroot-installer.sh -O /mnt/root/blackarch-chroot-installer.sh
chmod +x /mnt/root/blackarch-chroot-installer.sh

# Download package list
wget https://raw.githubusercontent.com/eb3095/arch-scripted/master/blackarch/packages.txt -O /mnt/root/packages.txt

# Create bootstrap
echo '#!/bin/bash' >> /mnt/root/bootstrap.sh
echo "/root/blackarch-chroot-installer.sh $drive" >> /mnt/root/bootstrap.sh
