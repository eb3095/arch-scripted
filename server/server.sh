...
# Download script
wget https://raw.githubusercontent.com/eb3095/arch-scripted/master/server/server-chroot-installer.sh -O /mnt/root/server-chroot-installer.sh
chmod +x /mnt/root/server-chroot-installer.sh

# Download package list
wget https://raw.githubusercontent.com/eb3095/arch-scripted/master/server/packages.txt -O /mnt/root/packages.txt
wget https://raw.githubusercontent.com/eb3095/arch-scripted/master/server/virt-packages.txt -O /mnt/root/virt-packages.txt

# Create bootstrap
echo '#!/bin/bash' >> /mnt/root/bootstrap.sh
echo "/root/server-chroot-installer.sh $drive" >> /mnt/root/bootstrap.sh
